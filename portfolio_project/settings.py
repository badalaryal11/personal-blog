...
ALLOWED_HOSTS = ['www.badal-aryal.com.np', 'badal-aryal.com.np', 'badalaryal11.pythonanywhere.com', '127.0.0.1', 'localhost', '.vercel.app']

CSRF_TRUSTED_ORIGINS = ['https://www.badal-aryal.com.np', 'https://badal-aryal.com.np']
...
MIDDLEWARE = [
    ...
    'blog.middleware.TrafficTrackingMiddleware',
]
